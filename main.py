...
WATCHLIST = {
    ...
    "헬스케어": {"LLY":"일라이릴리", "UNH":"유나이티드헬스", "HIMS":"힘스앤허스",
                 "CURE":"헬스케어 3x", "HQH":"헬스케어 펀드"},
    "금융": {"JPM":"JP모건", "MA":"마스터카드", "UYG":"금융 2x", "FXO":"금융 ETF"},
    "산업재": {"CAT":"캐터필러", "DUSL":"산업재 3x"},
    "반도체·메모리":  {"MU":"마이크론", "SNDK":"샌디스크", "STX":"씨게이트", "HXSCL":"SK하이닉스 ADR"},
    "반도체·파운드리":{"TSM":"TSMC", "INTC":"인텔"},
    "반도체·GPU":     {"NVDA":"엔비디아", "AMD":"AMD", "SOXL":"반도체 3x",
                       "ALAB":"아스테라랩스", "AMAT":"어플라이드머티어리얼즈",
                       "DELL":"델", "AVGO":"브로드컴", "MRVL":"마벨테크놀로지", "ASML":"ASML"},
    "데이터센터":    {"APLD":"어플라이드디지털", "NBIS":"네비우스", "CRWV":"코어위브", "IREN":"아이렌", "ANET":"아리스타네트웍스"},
    "소프트웨어":    {"MSFT":"마이크로소프트", "NOW":"서비스나우", "PLTR":"팔란티어", "CRWD":"크라우드스트라이크", "SNOW":"스노우플레이크", "DDOG":"데이터독", "NET":"클라우드플레어", "RDDT":"레딧"},
    ...
    "암호화폐":      {"ETHU":"이더리움 2x ETF", "MSTR":"마이크로스트래티지", "BMNR":"비트마인", "COIN":"코인베이스", "CIFR":"사이퍼마이닝"},
...
LEVERAGED = {"SOXL", "GDXU", "NAIL", "ETHU", "UYG", "CURE", "DUSL"}
