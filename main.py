...
WATCHLIST = {
    ...
    "반도체·GPU":     {"CBRS":"세레브라스", "NVDA":"엔비디아", "AMD":"AMD", "SOXL":"반도체 3x",
    ...
    "암호화폐":      {"ETHU":"이더리움 2x ETF", "MSTR":"마이크로스트래티지", "BMNR":"비트마인", "COIN":"코인베이스", "CIFR":"사이퍼마이닝", "CRCL":"서클"},
    "양자컴퓨팅":    {"IONQ":"아이온큐", "QBTS":"디웨이브", "INFQ":"인플렉션", "RGTI":"리게티컴퓨팅"},
    "우주·UAM":      {"RKLB":"로켓랩", "SPCX":"스페이스X", "PL":"플래닛랩스",
                      "JOBY":"조비에비에이션", "RDW":"레드와이어", "LUNR":"인튜이티브머신즈"},
