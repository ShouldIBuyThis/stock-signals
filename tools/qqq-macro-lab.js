...
/* ^TNX가 있으면 그걸 쓴다 — 금리 그 자체라 해석이 곧바르다.
     없거나 너무 짧을 때만 대체 티커(채권 가격, 부호 반전)로 내려간다. */
const RATE = (M.tnx && Object.keys(M.tnx).length >= 120) ? ["tnx",1,"^TNX 금리"]
  : [["zn",-1,"ZN=F 선물(역)"],["ief",-1,"IEF(역)"],["tlt",-1,"TLT(역)"]]
